...
$secret = 'c7dbf0e4-65ff-4b1d-a580-a2fb395a253b';
$headers = array();
...
$headers[] = 'X-Location: -6.405821,106.064193';
        ...
        echo "\n";
        echo "\e[92m-------------------------------------------------\n";
        echo "\e[92m|  TOOLS GOJEK AUTO REGISTER + AUTO SAVE TOKEN  |\n";  
        echo "\e[92m|               By : Faisal Helmi               |\n";
        echo "\e[92m-------------------------------------------------\n";
        echo "\n";
        ulang:
        echo "\e[96m[+] Masukin Nomor GOJEK Kamu Disini : ";
        ...
        if($regs->success == true) {
            otp:
            echo "\e[93m[+] Masukin Kode OTP Kamu Disini : ";
